  ...
  return (
    <section id="skills" className="relative py-32 px-12 z-1 " style={{ background: "linear-gradient(to bottom, transparent, rgba(6,13,20,.8) 40%, transparent)" }}>
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex flex-row flex-wrap justify-start items-center  md:items-baseline md:grid grid-cols-4" style={{ borderLeft: "1px solid #0d1e2e" }}>
                {SKILLS.map((cat, i) => (
                  <Reveal key={cat.category} delay={i * 0.09}>
                    <div className="px-8 py-10  " style={{ borderRight: "1px solid #0d1e2e" }}>
